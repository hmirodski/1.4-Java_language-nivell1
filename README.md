...
Implementa el algoritmo oficial del Ministerio del Interior de España para calcular la letra del DNI español basado en
el módulo 23.
...
en un entorno local con fines educativos y de aprendizaje de testing en Java.
